...
function Platform() {
  ...
  const cards = [{
    ...
    slot: "platform-contribute",
    placeholder: "Contribute image",
    graphic: "contribute",
    ...
    slot: "platform-invest",
    placeholder: "Invest image",
    graphic: "invest",
  ...
  const tri = encodeURIComponent("<svg xmlns='http://www.w3.org/2000/svg' width='52' height='90' viewBox='0 0 52 90'>" + "<path d='M0 0 H52 M0 45 H52 M26 45 L0 0 M26 45 L52 0 M26 45 L0 90 M26 45 L52 90' " + "stroke='rgba(20,20,19,0.13)' stroke-width='1' fill='none'/></svg>");
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Two ways to participate in the Node Ventures ecosystem."), /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, "Whether you want to build new ventures or invest in the vision behind them, Node connects you to an ecosystem built around Canada\u2019s digital future.")), /*#__PURE__*/React.createElement("div", {
    className: "nv-platform-cards",
    style: {
      position: "relative",
      display: "grid",
    ...
    key: c.title,
    style: {
      filter: "drop-shadow(0 -6px 44px rgba(20,20,19,0.16))"
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      padding: c.graphic ? "28px 0 0" : 24,
      paddingBottom: 0
    }
  }, c.graphic === "contribute" ? /*#__PURE__*/React.createElement(ContributeGraphic, null) : c.graphic === "invest" ? /*#__PURE__*/React.createElement(InvestGraphic, null) : /*#__PURE__*/React.createElement("image-slot", {
    id: c.slot,
    style: {
      display: "block",
      width: "100%",
