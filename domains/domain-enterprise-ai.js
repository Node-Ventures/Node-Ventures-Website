...
window.DOMAIN_ENTERPRISE_AI = {
  ...
  why: {
    ...
    cards: [{
      t: "Data readiness",
      image: "assets/why-ea-readiness.jpg",
      b: "Unify your documents, systems, and records into a governed knowledge layer that agents can query."
    }, {
      t: "Workplace modernization",
      image: "assets/why-ea-workplace.jpg",
      b: "Move teams onto cloud-native platforms where knowledge, access, and collaboration are easier to manage."
    }, {
      t: "Process automation",
      image: "assets/why-ea-process.jpg",
      b: "Identify high-value workflows where AI agents can reduce manual effort and improve consistency."
    }, {
      t: "Agentic AI deployment",
      image: "assets/why-ea-deploy.jpg",
      b: "Design and deploy role-specific agents that operate within defined tasks, permissions, and escalation paths."
    }, {
      t: "Security & governance",
      image: "assets/why-ea-security.jpg",
      b: "Build access control, audit logging, human review, and compliance into the architecture from day one."
    }, {
      t: "Conversational AI",
      image: "assets/why-ea-conversational.jpg",
      b: "Create voice and text assistants grounded in your organization's own data and processes, not generic AI responses."
    }]
  },
  quote: {
  ...
  getInvolved: {
    ...
    paths: [{
      label: "Phase 1",
      t: "Data readiness",
      b: "Prepare the organization for AI by modernizing workplace systems, organizing data, connecting key sources, and establishing the access controls and governance agents will rely on."
    }, {
      label: "Phase 2",
      t: "AI opportunity mapping",
      b: "Identify the workflows, pain points, and decision bottlenecks where AI can create measurable value, then prioritize the use cases that are practical and ready for implementation."
    }, {
      label: "Phase 3",
      t: "Agentic AI deployment",
      b: "Deploy governed AI agents into selected workflows with defined tasks, permissions, escalation paths, audit logging, and performance tracking."
    }]
  },
  hideVentures: true,
  ventures: {
